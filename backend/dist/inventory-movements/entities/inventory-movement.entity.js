...
__decorate([
    (0, typeorm_1.ManyToOne)(() => ingredient_entity_1.Ingredient, (ingredient) => ingredient.movements),
    (0, typeorm_1.JoinColumn)({ name: 'ingredientId' }),
    __metadata("design:type", ingredient_entity_1.Ingredient)
], InventoryMovement.prototype, "ingredient", void 0);
__decorate([
...
], InventoryMovement.prototype, "order", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'uuid', nullable: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: inventory_movement_type_enum_1.TipoMovimientoInventario }),
    __metadata("design:type", String)
