...
const KdsSoundSettings: React.FC = () => {
  ...
  return (
    <Card title={<><SoundOutlined /> Sonido de Notificación del KDS</>} style={{ marginTop: 24 }}>
      <Paragraph>
      ...
      {config?.kdsNotificationSoundUrl && (
        <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <Popconfirm
            title="¿Restablecer al sonido por defecto?"
            onConfirm={handleRemoveSound}
            okText="Sí"
            cancelText="No"
          >
...
const SettingsPage: React.FC = () => {
  return (
    <>
      ...
      <Paragraph>
        Ajusta las configuraciones específicas de tu negocio, como el área de reparto y las notificaciones.
      </Paragraph>
      {/* Aquí irían otros componentes de configuración como el del área de reparto */}
      <KdsSoundSettings />
    </>
  );
};
